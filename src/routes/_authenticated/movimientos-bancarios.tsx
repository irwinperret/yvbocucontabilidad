...
function MovimientosBancariosPage() {
  ...
  const badgeEstado = (e: EstadoConciliacion, clase?: string | null) => {
    ...
    return <Badge variant="destructive">Sin pareo (soporte pendiente)</Badge>;
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-7">
        ...
        <Kpi label="Sin pareo (soporte pendiente)" value={resumen.sin_pareo} tone="text-destructive" highlight={resumen.sin_pareo > 0} />
      </div>
          ...
          <div className="grid gap-3 md:grid-cols-4">
            ...
            <Select value={estadoF} onValueChange={setEstadoF}>
              ...
              <SelectContent>
                ...
                <SelectItem value="sin_pareo">Sin pareo (soporte pendiente)</SelectItem>
              </SelectContent>
            </Select>
