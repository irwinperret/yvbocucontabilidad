...
// Líneas del flujo de caja indirecto, una por mes (índice 0 = enero).
type LineasMes = {
  ebitda: number;
  cambioCxC: number;
...
const CUENTA_INGRESO_CREDITO = "1.4";
const CUENTA_COBRO_CREDITO = "1.5";
const CUENTAS_INGRESO_GYP = ["1.1", "1.2", "1.3", "1.4", "1.6", "1.7", "1.8"];
const CUENTAS_COGS = ["2.1", "2.2"];
const CUENTA_PAGO_CXP = "8.2";
const CUENTA_CAPEX = "5.6";
const CUENTA_CAPITAL = "5.5";
const CUENTA_PRESTAMO_RECIBIDO = "5.1";
const CUENTA_PAGO_CAPITAL_PRESTAMO = "5.2";
const CUENTA_INTERESES = "5.3";
const CUENTA_DIVIDENDOS = "5.4";
const CUENTAS_IMPUESTOS_GASTO = ["7.1", "7.2"];
